...
INSERT INTO merchants(name, description, phone, address, status) VALUES
('一食堂简餐', '米饭套餐、盖浇饭、汤品', '0411-100001', '一食堂一楼', 'open'),
('奶茶小站', '奶茶、果茶、咖啡', '0411-100002', '图书馆东侧', 'open'),
('夜宵窗口', '炒饭、炸串、面食', '0411-100003', '学生公寓北门', 'open');
...
INSERT INTO dishes(merchant_id, category_id, name, price, image_url, description, stock, status) VALUES
(1, 1, '照烧鸡腿饭', 16.80, '', '鸡腿鲜嫩，配时蔬和米饭', 80, 'on'),
(1, 1, '番茄牛腩饭', 19.90, '', '酸甜番茄汤汁配牛腩', 50, 'on'),
(2, 2, '珍珠奶茶', 9.90, '', '经典奶茶，甜度可备注', 120, 'on'),
(2, 2, '满杯水果茶', 12.80, '', '多种水果混合茶底', 90, 'on'),
(3, 3, '香辣炸串拼盘', 18.80, '', '适合夜宵分享', 60, 'on'),
(3, 1, '火腿蛋炒饭', 13.50, '', '现炒热卖', 70, 'on');
